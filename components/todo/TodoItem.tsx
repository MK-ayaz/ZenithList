    ...
    <GestureHandlerRootView style={{ width: '100%' }}>
      <GestureDetector gesture={gesture}>
        <Animated.View style={animatedStyle}>
          <View className="flex-row items-center p-4 bg-white dark:bg-slate-900 rounded-2xl mb-3 border border-slate-100 dark:border-slate-800">
            ...
            <View className="ml-3 flex-1">
              <Text className={`text-base font-medium ${todo.isCompleted ? 'line-through text-slate-400' : 'text-slate-900 dark:text-slate-100'}`}>
                {todo.title}
              </Text>
