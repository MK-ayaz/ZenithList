    ...
    <View style={[styles.container, { backgroundColor: c.surface }]}>
      <View style={styles.searchContainer}>
        <View style={[styles.searchBar, { backgroundColor: c.card, borderColor: c.border }]}>
          ...
          <TextInput value={searchQuery} onChangeText={setSearchQuery} placeholder="Search completed..." style={[styles.searchInput, { color: c.text }]} placeholderTextColor={c.textTertiary} />
